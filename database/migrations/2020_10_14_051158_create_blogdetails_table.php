...
class CreateBlogdetailsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Blogdetails", 'blogdetails', 'keyword', 'fa-cube', [
            ["title", "Title", "TextField", false, "", 0, 256, false],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["date", "Date", "Datetime", false, "", 0, 0, false],
            ["content", "content", "HTML", false, "", 0, 0, false],
            ["bannerimage2", "bannerimage2", "Image", false, "", 0, 0, false],
            ["tag", "tag", "TextField", false, "", 0, 256, false],
            ["category", "category", "Textarea", false, "", 0, 0, false],
            ["meta_image", "Meta Image", "Image", false, "", 0, 0, false],
            ["slug", "Slug", "TextField", true, "", 0, 256, true],
        ]);
    ...
    {
        if (Schema::hasTable('blogdetails')) {
