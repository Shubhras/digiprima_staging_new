...
class CreateMeetinghomesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Meetinghomes", 'meetinghomes', 'name', 'fa-cube', [
            ["name", "name", "TextField", false, "", 0, 256, false],
            ["email", "email", "Email", false, "", 0, 256, false],
            ["message", "Message", "Textarea", false, "null", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('meetinghomes')) {
            Schema::drop('meetinghomes');
        }
    }
}
