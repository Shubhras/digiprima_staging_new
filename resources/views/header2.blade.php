    ...
    @endif
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/specialties') }}" class="dropdown-toggle" data-toggle="dropdown">industry</a>
                ...
                <h6 class="title nav-menu-content-hide">industries</h6>
                  ...
                  <div class="col-menu col-md-4">
                      ...
                      <ul class="content-menu-list-type">
                        ...
                        <li class="content-menu-list"><a href="#">Oil and Gas </a></li>
                        <li class="content-menu-list"><a href="#">Cloud Services </a></li>
                      </ul>
                      <br>
                  </div>
          ...
          <li class="dropdown megamenu-fw"><a href="{{asset('/specialties') }}" class="dropdown-toggle" data-toggle="dropdown">servies</a>
          <ul class="dropdown-menu megamenu-content" role="menu">
              <li>
               <div class="row nav-menu-content-hide">
                <!-- <div class="col-md-4 desk-view"> -->
                ...
                <div class="row">
                         ...
                         <ul class="content-menu-list-type">
                        <li class="content-menu-list"><a href="#" >Artificial Intelligence</a></li></li>
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/about-us') }}" class="dropdown-toggle" data-toggle="dropdown">company</a>
            <ul class="dropdown-menu megamenu-content" role="menu">
              <li>
                <div class="row nav-menu-content-hide">
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/career') }}" class="dropdown-toggle" data-toggle="dropdown">career</a>
            <ul class="dropdown-menu megamenu-content" role="menu">
              <li>
              <div class="row nav-menu-content-hide">
                <!-- <div class="col-md-4 desk-view"> -->
          ...
          <li class="dropdown"> <a href="{{asset('/blog-list') }}"> Blog</a>
            
          </li>

          <li class="dropdown"> <a href="{{asset('/contact')}}"> contact us</a>
