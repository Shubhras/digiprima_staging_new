...
@section("contentheader_title", "Resumes")
@section("contentheader_description", "Resumes listing")
@section("section", "Resumes")
@section("sub_section", "Listing")
@section("htmlheader_title", "Resumes Listing")

@section("headerElems")
@la_access("Resumes", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Resume</button>
@endla_access
@endsection
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ResumesController@store', 'id' => 'resume-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/resume_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
