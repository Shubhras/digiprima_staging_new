...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $subscribe->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Subscribes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/subscribes/'.$subscribe->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Subscribes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.subscribes.destroy', $subscribe->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/subscribes') }}" data-toggle="tooltip" data-placement="right" title="Back to Subscribes"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'subscribes_email')
					</div>
				</div>
			</div>
		</div>
