...
@section("contentheader_title", "Testimonials")
@section("contentheader_description", "Testimonials listing")
@section("section", "Testimonials")
@section("sub_section", "Listing")
@section("htmlheader_title", "Testimonials Listing")

@section("headerElems")
@la_access("Testimonials", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Testimonial</button>
@endla_access
@endsection
