...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $rating_submission->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Rating_Submissions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/rating_submissions/'.$rating_submission->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Rating_Submissions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rating_submissions.destroy', $rating_submission->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rating_submissions') }}" data-toggle="tooltip" data-placement="right" title="Back to Rating Submissions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'enquiry_date')
						@la_display($module, 'name')
						@la_display($module, 'email')
						@la_display($module, 'mobile')
						@la_display($module, 'city')
						@la_display($module, 'course')
						@la_display($module, 'training_rating')
						@la_display($module, 'lab_rating')
						@la_display($module, 'guidance_rating')
