...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $company_page->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Company_Pages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/company_pages/'.$company_page->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Company_Pages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.company_pages.destroy', $company_page->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/company_pages') }}" data-toggle="tooltip" data-placement="right" title="Back to Company Pages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'contact_label')
						@la_display($module, 'contact_url')
						@la_display($module, 'hide_director')
						@la_display($module, 'hide_c_video')
						@la_display($module, 'banner_title')
						@la_display($module, 'banner_image')
						@la_display($module, 'banner_description')
						@la_display($module, 'story_lbl')
						@la_display($module, 'story_desc')
						@la_display($module, 'video_title')
						@la_display($module, 'company_lbl')
						@la_display($module, 'video_desc')
						@la_display($module, 'video')
						@la_display($module, 'learning_lbl')
						@la_display($module, 'learning_desc')
						@la_display($module, 'franchise_lbl')
						@la_display($module, 'franchise_desc')
						@la_display($module, 'mission_lbl')
						@la_display($module, 'award_label')
