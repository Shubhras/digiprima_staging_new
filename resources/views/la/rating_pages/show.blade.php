...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $rating_page->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Rating_Pages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/rating_pages/'.$rating_page->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Rating_Pages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rating_pages.destroy', $rating_page->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rating_pages') }}" data-toggle="tooltip" data-placement="right" title="Back to Rating Pages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'coupon_text')
						@la_display($module, 'coupon_desc')
						@la_display($module, 'rate_review_lbl')
						@la_display($module, 'faq_lbl')
						@la_display($module, 'faq_desc')
