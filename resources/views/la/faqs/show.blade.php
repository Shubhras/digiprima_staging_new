...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Faqs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/faqs/'.$faq->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Faqs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.faqs.destroy', $faq->id], 'method' => 'delete', 'style'=>'display:inline']) }}
