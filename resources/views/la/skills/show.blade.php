...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			...
			@la_access("Skills", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.skills.destroy', $skill->id], 'method' => 'delete', 'style'=>'display:inline']) }}
