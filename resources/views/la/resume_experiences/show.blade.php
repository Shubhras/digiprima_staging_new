...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $resume_experience->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Resume_experiences", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/resume_experiences/'.$resume_experience->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Resume_experiences", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.resume_experiences.destroy', $resume_experience->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/resume_experiences') }}" data-toggle="tooltip" data-placement="right" title="Back to Resume experiences"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'resume_id')
						@la_display($module, 'experience_from')
						@la_display($module, 'experience_to')
						@la_display($module, 'company_name')
						@la_display($module, 'roles_and_resp')
						@la_display($module, 'current_working')
						@la_display($module, 'work_city')
