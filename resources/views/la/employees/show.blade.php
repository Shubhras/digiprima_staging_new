			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'building_name')
						@la_display($module, 'landmark')
						@la_display($module, 'road')
						@la_display($module, 'locality_area')
						@la_display($module, 'state')
						@la_display($module, 'country')
						@la_display($module, 'zip_pin')
						@la_display($module, 'fixed')
						@la_display($module, 'variable')
						...
						@la_display($module, 'no_of_employees')
						...
						@la_display($module, 'headquarters_city')
						@la_display($module, 'looking_change')
						...
						@la_display($module, 'door_floatno')
					</div>
				</div>
			</div>
		</div>
