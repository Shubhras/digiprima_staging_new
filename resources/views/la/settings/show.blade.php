			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'profile_build_title')
						@la_display($module, 'cvbuilder_image')
						@la_display($module, 'employer_banner')
						@la_display($module, 'twitter_link')
						@la_display($module, 'facebook_link')
						@la_display($module, 'google_link')
						@la_display($module, 'linkedin_link')
						@la_display($module, 'image_meta_url')
						@la_display($module, 'meta_url_description')
						@la_display($module, 'page_url')
						@la_display($module, 'get_started_url')
						@la_display($module, 'footer_p')
						@la_display($module, 'copy_right1')
						@la_display($module, 'copy_right2')
						@la_display($module, 'job_seeker_title')
						@la_display($module, 'job_seeker_desc')
						@la_display($module, 'employer_title')
						@la_display($module, 'employer_desc')
						@la_display($module, 'trainings_title')
						@la_display($module, 'trainings_desc')
						@la_display($module, 'latest_blog_news')
						@la_display($module, 'subscribe_news_title')
						@la_display($module, 'subscribe_news_desc')
						...
						@la_display($module, 'mobile1')
						@la_display($module, 'mobile2')
						@la_display($module, 'explore_best')
						@la_display($module, 'career_oriented')
						@la_display($module, 'top_course')
						@la_display($module, 'top_course_desc')
						@la_display($module, 'latest_tech_lbl')
						@la_display($module, 'latest_tech_desc')
						@la_display($module, 'hiring_partner_lbl')
						@la_display($module, 'hiring_partner_desc')
						@la_display($module, 'hiring_partner_text')
						@la_display($module, 'world_talking_about')
						@la_display($module, 'get_started')
						@la_display($module, 'copy_right')
						@la_display($module, 'footer_logo')
					</div>
				</div>
			</div>
		</div>
