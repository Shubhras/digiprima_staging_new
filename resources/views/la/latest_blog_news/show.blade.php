...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $latest_blog_news->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Latest_blog_news", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/latest_blog_news/'.$latest_blog_news->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Latest_blog_news", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.latest_blog_news.destroy', $latest_blog_news->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/latest_blog_news') }}" data-toggle="tooltip" data-placement="right" title="Back to Latest blog news"><i class="fa fa-chevron-left"></i></a></li>
