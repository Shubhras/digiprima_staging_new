...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $contact_page->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Contact_Pages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/contact_pages/'.$contact_page->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Contact_Pages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.contact_pages.destroy', $contact_page->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contact_pages') }}" data-toggle="tooltip" data-placement="right" title="Back to Contact Pages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'call_text')
						@la_display($module, 'form1_lbl')
						@la_display($module, 'from2_label')
						@la_display($module, 'form3_label')
						@la_display($module, 'locate_lbl')
						@la_display($module, 'locate_desc')
