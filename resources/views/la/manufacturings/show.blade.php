...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $manufacturing->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Manufacturings", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/manufacturings/'.$manufacturing->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Manufacturings", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.manufacturings.destroy', $manufacturing->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/manufacturings') }}" data-toggle="tooltip" data-placement="right" title="Back to Manufacturings"><i class="fa fa-chevron-left"></i></a></li>
