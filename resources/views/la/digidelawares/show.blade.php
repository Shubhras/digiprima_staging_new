...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $digidelaware->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Digidelawares", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/digidelawares/'.$digidelaware->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Digidelawares", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.digidelawares.destroy', $digidelaware->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/digidelawares') }}" data-toggle="tooltip" data-placement="right" title="Back to Digidelawares"><i class="fa fa-chevron-left"></i></a></li>
