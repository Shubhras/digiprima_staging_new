...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $navigation_jobseeker->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Navigation_jobseekers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/navigation_jobseekers/'.$navigation_jobseeker->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Navigation_jobseekers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.navigation_jobseekers.destroy', $navigation_jobseeker->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/navigation_jobseekers') }}" data-toggle="tooltip" data-placement="right" title="Back to Navigation jobseekers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'enable')
						@la_display($module, 'sort_order')
						@la_display($module, 'slug1')
					</div>
				</div>
			</div>
		</div>
