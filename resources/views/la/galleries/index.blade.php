...
@section("contentheader_title", "Galleries")
@section("contentheader_description", "Galleries listing")
@section("section", "Galleries")
@section("sub_section", "Listing")
@section("htmlheader_title", "Galleries Listing")

@section("headerElems")
@la_access("Galleries", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Gallery</button>
@endla_access
@endsection
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\GalleriesController@store', 'id' => 'gallery-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/gallery_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
