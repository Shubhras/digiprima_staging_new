...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $gallery->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Galleries", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/galleries/'.$gallery->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Galleries", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.galleries.destroy', $gallery->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/galleries') }}" data-toggle="tooltip" data-placement="right" title="Back to Galleries"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'lab_title')
						@la_display($module, 'lab_desc')
						@la_display($module, 'master_title')
						@la_display($module, 'master_desc')
						@la_display($module, 'social_title')
						@la_display($module, 'social_desc')
