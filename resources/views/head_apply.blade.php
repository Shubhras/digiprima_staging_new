  ...
  <nav class="navbar navbar-default navbar-fixed  white bootsnav ">
    ...
    @endif
      ...
      <!--== Collect the nav links, forms, and other content for toggling ==-->
       <div class="collapse navbar-collapse ccc" id="navbar-menu">
        <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/specialties') }}"style="color: black;" >Services</a>
            <ul class="dropdown-menu megamenu-content hidden-xs sm-display-none" role="menu">
              <li>
                <div class="row">
                  <div class="col-md-12"> 
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/about-us') }}" style="color: black;">Company</a>
            <ul class="dropdown-menu megamenu-content hidden-xs sm-display-none" role="menu">
              <li>
                <div class="row">
                  <div class="col-menu col-md-12">
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/career') }}" style="color: black;">career</a>
            <ul class="dropdown-menu megamenu-content hidden-xs sm-display-none" role="menu">
              <li>
                <div class="row">
                  <div class="col-menu col-md-12">
          ...
          <li class="dropdown megamenu-fw"> <a href="{{asset('/blog-list') }}" style="color: black;">Blog</a></li>

          <li class="dropdown"> <a href="{{asset('/contact')}}" style="color: black;">Contact us</a></li>
