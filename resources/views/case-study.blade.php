  ...
  <div class="container">
      ...
      <div class="row mt-100">
        ...
        <div class="col-md-6">
          <figure class=" text-center portfolio-type-2">
            <img src="{{asset('images/loanmoksha.png')}}" alt="LoanMoksha" title="LoanMoksha">

            <figcaption class="dark-bg">
              <div class="center-layout">
                <div class="v-align-middle">
                  <a class="magnific-lightbox" href="assets/images/portfolio/grid/30.jpg" title="LoanMoksha" alt="LoanMoksha">
                  </a>
                </div>
              </div>
            </figcaption>
    ...
    <div class="row mt-100">
      ...
      <div class="col-md-6">
        ...
        <figure class=" text-center portfolio-type-2">
          <img src="{{asset('images/mdout.png')}}" alt="MDout" title="MDout">
          <figcaption class="dark-bg">
            <div class="center-layout">
              <div class="v-align-middle">
    ...
    <div class="row">
      ...
      <div class="row mt-70">
        ...
        <div class="col-md-6">
          <figure class=" text-center portfolio-type-2">
            <img src="{{asset('images/my-thana-app.png')}}" alt="My Thana App" title="My Thana App">
            <figcaption class="dark-bg">
              <div class="center-layout">
                <div class="v-align-middle">
    ...
    <div class="row mt-100">
      ...
      <div class="col-md-6">
        ...
        <figure class=" text-center portfolio-type-2">
          <img src="{{asset('images/mdout.png')}}" alt="BetHite" title="BetHite">
          <figcaption class="dark-bg">
            <div class="center-layout">
              <div class="v-align-middle">
                <a class="magnific-lightbox" href="assets/images/portfolio/grid/31.jpg">
    ...
    <div class="row mt-100">
      <div class="col-md-6">
        <h2 class="mt-0 font-700" style="color: black;">SchollyMe</h2>
      ...
      <div class="col-md-6">
        ...
        <figure class=" text-center portfolio-type-2">
          <img src="{{asset('images/mob-apps.png')}}" alt="SchollyMe" title="SchollyMe">
          <figcaption class="dark-bg">
            <div class="center-layout">
              <div class="v-align-middle">
                <a class="magnific-lightbox" href="assets/images/portfolio/grid/31.jpg">
    ...
    <div class="row">
      ...
      <div class="row mt-70">
        ...
        <div class="col-md-6">
          <figure class=" text-center portfolio-type-2">
            <img src="{{asset('images/lekumeia.png')}}" alt="Leukemia & Lymphoma Society" title="Leukemia & Lymphoma Society">
            <figcaption class="dark-bg">
              <div class="center-layout">
                <div class="v-align-middle">
                  <a class="magnific-lightbox" href="">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <h2 class="mt-0 font-700" style="color: black; margin-left: 12%">Leukemia & Lymphoma Society
          </h2>
    ...
    <div class="row mt-100">
      <div class="col-md-6">
        <h2 class="mt-0 font-700" style="color: black;">Street Authority </h2>
...
<div class="row mt-70">
  ...
  <div class="col-md-6">
    <figure class=" text-center portfolio-type-2">
      <img src="{{asset('images/my-thana-app.png')}}" alt="Telaqua" title="Telaqua">
      <figcaption class="dark-bg">
        <div class="center-layout">
          <div class="v-align-middle">
            <a class="magnific-lightbox" href="">
  ...
  <div class="col-md-6 col-sm-12 col-xs-12">
    <h2 class="mt-0 font-700" style="color: black; margin-left: 12%">Telaqua</h2>
    <h3 class=" roboto-font mt-0 mb-0" style="color: black; margin-left: 12%">Smart Agriculture & Smart Building (IoT) Case Study</h3>
    <hr class="dark-bg left-line" style="color: black; margin-left: 12%">
    <p class="mt-30" style="color: black; margin-left: 12%"><a href="Telaqua-case-study" target="blank" class="btn btn-dark btn-md radius-0">See this Project</a></p>
  </div>
...
<div class="row mt-100">
      <div class="col-md-6">
        <h2 class="mt-0 font-700" style="color: black;">Owl</h2>
        <h3 class=" roboto-font mt-0 mb-0" style="color: black;">Owl
        </h3>
        <hr class="dark-bg left-line">
        <p class="mt-30"><a href="owl-case-study" target="blank" class="btn btn-dark btn-md radius-0">See this Project</a></p>
...
<div class="row mt-70">
  ...
  <div class="col-md-6 col-sm-12 col-xs-12">
    <h2 class="mt-0 font-700" style="color: black; margin-left: 12%">NeuralMarker</h2>
    <h3 class=" roboto-font mt-0 mb-0" style="color: black; margin-left: 12%">NeuralMarker</h3>
    <hr class="dark-bg left-line" style="color: black; margin-left: 12%">
    <p class="mt-30" style="color: black; margin-left: 12%"><a href="neuralmarker-case-study" target="blank" class="btn btn-dark btn-md radius-0">See this Project</a></p>
  </div>
