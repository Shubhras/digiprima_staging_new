...
<html>
 ...
 <style> 
   ...
   <span leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0"
  style="margin: 0pt auto; padding: 0px; background:none !important;">
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                    <!-- <img alt="Coinbase" width="180" src="{{ asset('/img/10genjobslogo1.png')}}"/> -->
                                ...
                                <tr>
                                  <td align="center"> <p> <br><br> <b><font size="80px" color="red" > Contact details </font> <br>
            
                <table border="none">
                    <tr><td><b>First Name : </b>{{ $first_name }} </td></tr>
                    <tr><td><b> Last Name : </b>{{ $last_name }} </td></tr>
                    <tr><td><b>Email : </b>{{ $email }}  </td></tr>
                    <tr><td><b>Phone : </b>{{ $phone }}  </td></tr>
                    <tr><td><b>Apply For : </b>{{ $apply_for }}  </td></tr>
                    <tr><td><b>Highest Qualification Details : </b>{{ $qualification }}  </td></tr>
