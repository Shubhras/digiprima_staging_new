...
<section class="title-hero-bg " style="background-image:url(images/banner-img.jpg);">
<!-- <section class="title-hero-bg " style="background: #b3bbe2;"> -->
        <div class="container">
          <div class="row mt-50">
              <div class="col-md-12 mt-75">
                <div class=" text-center white-color">
                  <h1 class="textg">Most-Trusted<br>
Python Development Company</h1>
...
<section class="grey-bg1">
    <div class="container">
      <div class="row">
       <div class="col-md-6">
              <h3 class="font-600">Hire Highly Qualified Python Developers.</h3>
              <!-- <h2 class="mt-10 font-700 roboto-font">We're Digiprima.</h2> -->

              <p class="mt-20"> Are you looking to hire python developers? Great choice! Hire top developers from DigiPrima Technologies, as we are globally renowned as a prominent python development company. We are helping all the shapes and sizes of businesses to build Python-driven custom web applications, desktop apps, and dynamic websites in advanced Python frameworks such as Flask, Web2py, and Django implementing the latest Python tools.</p>
          <ul class="sect">
      ...
      <div class="col-md-6 mobile-hide">
        <img class="" src="{{asset('images/data-img1.png')}}" alt="outsource node js development company"/>
...
<section class="grey-bg2">
    <div class="container">
      <div class="row">
      <div class="col-md-6 mobile-hide">
        <img class="" src="{{asset('images/data-img2.jpg')}}" alt="outsource node js development company"/>  
      </div>
       <div class="col-md-6">
              <h3 class="font-600">Why Choose DigiPrima For Your Python Development Project?</h3>
              <!-- <h2 class="mt-10 font-700 roboto-font">We're Digiprima.</h2> -->

              <p class="mt-20">DigiPrima is a leading Python development company with top-of-the-line Python developers who have in-depth knowledge and enormous experience in developing complex Python-driven applications. We have a proven track record of delivering Python Django software & web development projects to large scale enterprises.
                  <br>
    ...
    <div class="container">
      <div class="row">
         <div class="col-sm-12 section-heading">
                <h3 class="dark-color   font-35px font-700 ">Enterprise Python Development Solutions and Services</h3>
       <p class="sectionp2">DigiPrima provides secure, scalable and performance based Python development solutions that enable us to achieve our client's end goals and deliver timely output with qualified deployment.</p>
...
<section>
    <div class="container">
    	<div class="row">
      <div class="col-md-12 col-xs-12">
        <h2 class="mt-d font-700">Python development Framework</h2>
      </div>
        </div>
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <i class="icofont icofont-dashboard-web font-50px default-color"></i>
                    <h4 class="font-600">Django</h4>
                    <p class="font-400 mt-20">We are among the top-rated companies working on python that are experts in developing high-performance applications with Django. With years of knowledge and a successful track record of providing best Django development services to our clients across the globe.</p>
                  </div>
                </div>
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <i class="icofont icofont-chart-line font-50px default-color"></i>
                    <h4 class="font-600">Flask</h4>
                    <p class="font-400 mt-20">It is a customizable Python outline that is used to build highly-flexible applications. We are one of the top rated python developers that crafts informative, engaging, and responsive apps with a multipurpose flask framework.</p>
                  </div>
                </div>
                <div class="box-back height-300px default-bg">
                  <div class="content-wrap white-color1">
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <i class="icofont icofont-maximize font-50px default-color"></i>
                    <h4 class="font-600">Tornado</h4>
                    <p class="font-400 mt-20">It is an open source Python web framework and asynchronous networking library, originally developed at FriendFeed. It helps in developing scalable applications with non-blocking HTTP servers and low-level I/O modules, giving them an edge over the competitors in terms of speed.</p>
                  </div>
                </div>
                <div class="box-back height-300px default-bg">
                  <div class="content-wrap white-color1">
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <!-- <img src="images/service-options-bi-implementation.svg" height="40px" width="70px" alt="education software development company" title="Transforming technical advancements"> -->
                    ...
                    <h4 class="font-600">Zope</h4>
                    <p class="font-400 mt-20">Endorsement with a large community Zope is a renowned python framework that has a famous set of native tools. It has a properly-defined object database that lets you build an application that guarantees errorless security at all levels.</p>
                  </div>
                </div>
                <div class="box-back height-300px default-bg">
                  <div class="content-wrap white-color1">
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <!-- <img src="images/da-modernization.svg" height="40px" width="70px" alt="education software development company" title="Transforming technical advancements"> -->
                    ...
                    <h4 class="font-600">Pyramid</h4>
                    <p class="font-400 mt-20">It is an overall, open source, web application development framework made in python. With this framework choice, you can expect quick development and easier deployment of applications. We are a top-leading python application development company in the globe.</p>
                  </div>
                </div>
                <div class="box-back height-300px default-bg">
                  <div class="content-wrap white-color1">
              ...
              <div class="text-center mb-50 main-box">
                <div class="box-front height-300px white-bg">
                  ...
                  <!-- <img src="images/data-management-services.svg" height="40px" width="70px" alt="education software development company" title="Transforming technical advancements"> -->
                    ...
                    <h4 class="font-600">Web2Py</h4>
                    <p class="font-400 mt-20">It is an open-source web application framework written in the Python programming language. Supports MVC architectural design, Web2Py is a full-stack outline that helps in building secure, portable, and database-driven applications. It easy web and mobile application development and safeguards the project is interactive and responsive.</p>
                  </div>
                </div>
                <div class="box-back height-300px default-bg">
                  <div class="content-wrap white-color1">
