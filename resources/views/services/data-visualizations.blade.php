...
<section class="title-hero-bg " style="background-image:url(images/power-bi1.jpg);">
<!-- <section class="title-hero-bg " style="background: #b3bbe2;"> -->
        <div class="container">
          <div class="row mt-50">
              <div class="col-md-12 mt-75">
                <div class=" text-center white-color">
                  <h1 class="textf">Data Visualization</h1>
                  <h4 class="mt-30" style="margin-top: 4px; text-align: center;">Real-time dashboards
Create and deploy analytics reports with Power BI</h4>
...
<section class="grey-bg1">
    <div class="container">
      <div class="row">
       <div class="col-md-6">
              <h3 class="font-600">Hire Skilled Developers for Data Visualizations</h3>
              <!-- <h2 class="mt-10 font-700 roboto-font">We're Digiprima.</h2> -->

              <p class="mt-20">What’s the story behind your data? Data Visualization tools enable you to identify the trends and patterns embedded in your data.  
              With the increase of big data incorporates, many enterprises are using data visualization tools to gain data insights that are accessible from any gadget at any time.
              Transform your enterprise into a data-led business and achieve sustainable organic growth with our<b> Power Platform.</b></p>
          <ul class="sect">
          <li>See the embedded patterns and trends</li>
          <li>Make strategic and better decisions</li>
          <li>Present meaningful data</li>
          </ul>
            </div>
    ...
    <div class="container">
      ...
      <div class="col-md-6 mobile-hide">
       ...
       <div class="col-md-6">
              ...
              <p class="mt-20">Digi Prima has been offering data visualisations consulting services for years. Digi Prima helps businesses engage with interactive and real-time dashboards for IoT Devices and Network components. We also offer customized templates for Data visualization solutions using the latest technology stack like React.js, HighCharts, and d3.js to help organisations identify and visualize small to very large datasets. 
Our customized services are tailor-made to clients' requirements and budgets and help strengthen the business with advanced data visualisation capabilities.</p>
              <h4 class="font-500">Our Capabilities and Achievements</h4>
          <ul class="sect">
          <li>5 years in data analytics and visualisation consulting and hands-on practice in business intelligence.</li>
    ...
    <div class="container">
      <div class="row">
         <div class="col-sm-12 section-heading">
                <h3 class="dark-color   font-35px font-700 ">Data Visualisation Consulting Services</h3>
       <p class="sectionp2">Are you seeking qualitative, reliable, and cost-effective <b> BI- Data Visualisation tools and technologies?</b>  Digi Prima today for any consulting services to help you overcome your challenges and take your company forward on the growth path.</p>
...
<section class="white-bg" style="padding-top: 30px; padding-bottom: 40px;">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 section-heading">
        <h3 class="dark-color   font-35px font-700 ">Data Visualisation Strategy- Interactive and Intuitive Solutions</h3>
        <p class="sectionp2">Digi Prima experienced Data Visualisation Consultants will design the strategy and implementation framework. Our expert team will provide   end to end data visualization solutions to activate real time and meaningful insights to build interactive and intuitive dashboards.</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <h2 class="mt-d font-700">Visual analytics
Real-time dashboards</h2>
      </div>
    </div>
...
<section>
    <div class="container">
    	<div class="row">
      <div class="col-md-12 col-xs-12">
        <h2 class="mt-d font-700">Our data visualisation consulting services and solutions</h2>
      </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <h2 class="mt-d font-700">Data Visualisation Best Features</h2>
      </div>
    </div>
    <div class="row mt-10 text-m">
      <div class="col-md-12 col-xs-12 main-heading">
          <p class="text-alian">Our consultants at Digi Prima will deploy solutions after in depth research into your needs and requirements. Our consultants will advise you only on the best options and won't take you on energy and revenue draining paths. We prioritize your needs and budgets and will clearly explain data sources, data flows, and the exact functions of each component. Our employee training sessions will explain the process from top leadership to frontline executives to ensure a seamless implementation and usage of solutions.</p>
        </div>
        <!-- <a href="{{url('https://calendly.com/shubhra-s/30min?month=2022-02')}}" >
            <button type="submit" name="submit" class="btn btn-md btn-color btn-animate" style="margin-left: 467px; margin-top: 12px;"><span>talk to our expert<i class="tr-icon icofont icofont-arrow-right"></i></span></button></a> -->
          </div>
    ...
    <div class="container">
    	  <div class="row">
            <div class="centerize-col text-center white-color relative">
              <h3 class="roboto-font-size font-700">EXPLORE OUR DATA VISUALISATIONS CONSULTING SERVICE HERE</h3>
