...
Route::get('/data-visualizations', function () {
    return view('services.data-visualizations') . view('footer2');
});
Route::get('/python-developmentcopy', function () {
    return view('services.python-development1') . view('footer2');
});
...
//Python page latest
// Route::get('/lp/python-developer-latest', function () {
//     return view('tech.lp.python-developer-latest');
// });
